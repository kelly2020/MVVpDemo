package app.demo.wondersgroup.com.recyclerviewrefresh.view;
    ...
    private void smoothScrollBy(int dx, int dy) {
        ...
        if (isBottom) {
            ...
            if (!isLoading) {
                ...
                footContentView.findViewById(R.id.progress_bar).setVisibility(GONE);
            }
    ...
    public void onStopNestedScroll(View child) {
        ...
        if (isBottom && !isLoading && rootLayout.getScrollY() == footView.getMeasuredHeight()) {
            ...
            ((TextView) footContentView.findViewById(R.id.status_tv)).setText("正在加载...");
             footContentView.findViewById(R.id.progress_bar).setVisibility(VISIBLE);
            if (listener != null) {
                listener.onLoading();
            }
        } else {
